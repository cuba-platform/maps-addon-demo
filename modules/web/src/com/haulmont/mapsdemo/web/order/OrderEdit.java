package com.haulmont.mapsdemo.web.order;

import com.haulmont.mapsdemo.entity.Order;
...
public class OrderEdit extends AbstractEditor<Order> {
    ...
    public void init(Map<String, Object> params) {
        ...
        if (orderLayer != null) {
            ImagePointIcon icon = new ImagePointIcon("classpath:/com/haulmont/mapsdemo/web/cuba_icon.png");
